...
# python sample_database//submit_crownrun_per_sample.py --analysis tau --config config_fullsyst --production-tag NanoV14_2022MC_all_Version13_syst_mt --sample-list sample_database/Htautau_input_list/NanoV12_2022MC_all.txt --scopes '["mt"]'   --files-per-task 3
# python sample_database//submit_crownrun_per_sample.py --analysis tau --config config_fullsyst --production-tag NanoV14_2023MC_all_Version13_syst_mt --sample-list sample_database/Htautau_input_list/NanoV12_2023MC_all.txt --scopes '["mt"]'   --files-per-task 3
